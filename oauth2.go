...
type OAuth2Provider interface {
	...
	// NewDeviceUserRequest returns an DeviceUserRequest.
	// This endpoint is a loose implementation of the Authorize endpoint
	// but instead of a code, it's a user_code that is generated by the device endpoint
	NewDeviceUserRequest(ctx context.Context, req *http.Request) (DeviceUserRequester, error)

	// NewDeviceUserResponse
	// This endpoint is a loose implementation of the Authorize endpoint
	// but instead of a code, it's a user_code that is generated by the device endpoint
	NewDeviceUserResponse(ctx context.Context, requester DeviceUserRequester, session Session) (DeviceUserResponder, error)

	// WriteDeviceUserResponse
	// Once the user is authorized, it is being redirect to the login page;
	WriteDeviceUserResponse(ctx context.Context, r *http.Request, rw http.ResponseWriter, requester DeviceUserRequester, responder DeviceUserResponder)
...
type DeviceUserResponder interface {
	Responder
}
